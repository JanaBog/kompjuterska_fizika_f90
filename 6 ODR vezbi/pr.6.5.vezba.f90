program rk2_midpoint_oscillator_exercise
    implicit none
    ! Ekspliziten RK2 (midpoint) za x'' = -x
    ! Sistem:
    !   x' = v
    !   v' = -x
    !
    ...
    ! TODO: write(50,'(F12.6,'','',F12.6,'','',F12.6,'','',F12.6,'','',F12.6,'','',F12.6)') ...
    ...
    do i = 1, nsteps
        ...
        ! 2) Sredna tochka
        ! TODO: x_mid = x + 0.5d0*h*k1x
        ! TODO: v_mid = v + 0.5d0*h*k1v
...
end program rk2_midpoint_oscillator_exercise

program rk2_better_oscillator
    implicit none
    ! "Podobar" RK2 za harmoniski oscilator:
    !   x'' = -x
    ! Sistem:
    !   x' = v
    !   v' = -x
    ...
    write(60,'(F12.6,'','',F12.6,'','',F12.6,'','',F12.6,'','',F12.6,'','',F12.6)') &
    ...
    do i = 1, nsteps
        ...
        x2 = x + (2.0d0/3.0d0)*h*k1x
        v2 = v + (2.0d0/3.0d0)*h*k1v
        ...
        ! 4) RK2 chekor
        x = x + h*(0.25d0*k1x + 0.75d0*k2x)
        v = v + h*(0.25d0*k1v + 0.75d0*k2v)
...
end program rk2_better_oscillator
